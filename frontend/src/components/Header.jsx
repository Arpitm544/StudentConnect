      ...
      <div className="flex items-center gap-4 flex-1 max-w-xl">
        ...
        <div className="relative flex-1 group">
          ...
          <input
            ...
            className="w-full bg-background-secondary border border-border-subtle rounded-xl py-2.5 pl-10 pr-4 text-sm font-medium text-text-primary placeholder:text-text-secondary/40 focus:outline-none focus:border-accent/30 focus:ring-4 focus:ring-accent/5 transition-all"
          />
        </div>
      </div>
